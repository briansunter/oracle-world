...
resource "oci_monitoring_alarm" "cpu_high" {
  ...
  body = "CPU utilization has exceeded ${var.cpu_high_threshold}% for 15+ minutes. Consider optimizing workloads or redistributing load."
...
resource "oci_monitoring_alarm" "memory_high" {
  ...
  body = "Memory utilization has exceeded ${var.memory_high_threshold}% for 15+ minutes. Consider optimizing workloads or reducing memory usage."
